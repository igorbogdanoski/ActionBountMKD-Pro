...
- [ ] H3f MobilePlayer shell и stage players, последни.
  ...
  - [ ] H3f-3 Player stage components по сродни мали групи.
    ...
    - [ ] H3f-3b Mission и Switch input/action players.
    - [ ] H3f-3c FindSpot и QR device-assisted players.
...
Продолжи со H3f-3b: Mission и Switch input/action players, со посебно внимание на audio retake/submit и choice selected/disabled semantics. Не мешај FindSpot/QR/Quiz или Card миграција во истиот batch. По H3f направи целосен Button completion audit пред H4 Card. Важи focused contracts, full suite/build и desktop/mobile QA; R15 останува контролиран и се ревидира при Expo/Firebase Admin major-upgrade планирањето.
